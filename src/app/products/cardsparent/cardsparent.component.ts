...
@Component({
  selector: 'app-cardsparent',
  templateUrl: './cardsparent.component.html',
  styleUrls: ['./cardsparent.component.css']
})
export class CardsparentComponent {
  imagePath: string = 'assets/photo.png';
  ...
  ngOnInit() {
    this.cardsService.getGamesList().subscribe(
      (data: any) => this.cardsList = data.products,
    );
